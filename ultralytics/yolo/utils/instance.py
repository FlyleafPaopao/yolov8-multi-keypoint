...
class Bboxes:
    ...
    def __init__(self, bboxes, points, format="xyxy") -> None:
...
class Instances:
    ...
    def __init__(self, bboxes, segments=None, keypoints=None, bbox_format="xywh", normalized=True) -> None:
        ...
        if segments is None:
            segments = []
        self._bboxes = Bboxes(bboxes=bboxes, points=keypoints, format=bbox_format)
    ...
    def update(self, bboxes, segments=None, keypoints=None):
        new_bboxes = Bboxes(bboxes,keypoints, format=self._bboxes.format)
